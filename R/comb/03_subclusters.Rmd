...
packages <- c(
  ...
  "data.table", "GSVA", "edgeR", "ComplexHeatmap", "ClusterMap", "filesstrings", "patchwork"
)
...
for (i in seq_along(markers)) {
  if (any(markers[[i]] %in% rownames(sub_seurat))) {
    print(names(markers[i]))
    print(FeaturePlot(sub_seurat, markers[[i]], order = TRUE, cols = c("lightgrey", "red")))
  }
}
```
...
```{r}
sub_seurat <- seurat[ , which(seurat$rca_clusters == "Unclassified")]

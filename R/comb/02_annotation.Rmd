...
rds2 <- file.path(cache_dir, "bhaduri_primary_panel_Subtype.rds")
if (file.exists(rds)) {
  rca <- readRDS(rds)
  ref <- readRDS(rds2)
} else {
...
rds2 <- file.path(cache_dir, "bhaduri_primary_panel_custom.rds")
if (file.exists(rds)) {
  rca <- readRDS(rds)
  ref <- readRDS(rds2)
} else {
...
rds2 <- file.path(cache_dir, "bhaduri_primary_panel_filt.rds")
if (file.exists(rds)) {
  rca <- readRDS(rds)
  ref <- readRDS(rds2)
} else {

...
gene_sets <- str_split(bhaduri_markers$Rationale, ", ")
names(gene_sets) <- bhaduri_markers$TypeSubtype

gsva <- gsva(
  logcounts(pseudobulk), gene_sets, method = "ssgsea", ssgsea.norm = FALSE, verbose = FALSE
)

...
seurat_list$D72$sample <- factor(
  ...
  c(
    "D72_WT_rep1", "D72_WT_rep2", "D72_HET_rep1",
    "D72_HET_rep2", "D72_HOMO_rep1", "D72_HOMO_rep2"
  )
)
seurat_list$D120$sample <- factor(
  seurat_list$D120$sample,
  c(
    "D120_WT_rep1", "D120_WT_rep2", "D120_HET_rep1",
    "D120_HET_rep2", "D120_HOMO_rep1", "D120_HOMO_rep2"
  )
)
```

...
for (i in seq_along(seurat_list)) {
  ...
  seurat_list[[i]]$subclusters <- factor(
    ...
    c("Mu", "IPC",  "RG Late", "RG Early",
      "RG Astrocyte", "In Unclassified", "In", "Ex Unclassified",
      "Ex Newborn", "Ex Upper Layer", "Ex Deep Layer"
    )
  )
}
...
ggplot(df, aes(Sample, Proportion, fill = Celltype)) +
  ...
  scale_fill_manual(
    breaks = c(
      "Ex Deep Layer", "Ex Upper Layer", "Ex Newborn", "Ex Unclassified",
      "In", "In Unclassified", "RG Astrocyte", "RG Early", 
      "RG Late", "IPC", "Mu"
    ),
    values = as.vector(cols25(length(unique(df$Celltype))))
  )

...
write.csv(
  ...
  file.path(
    ...
    "comb",
    "04-DEGs",
    paste(sub_name, names(seurat_list[seurat_idx]), "UpperLayer1", "DEGs.csv", sep = "-")
  )
)
datatable_download_exp(results)
```
...
write.csv(
  ...
  file.path(
    ...
    "04-DEGs",
    paste(
      sub_name, names(seurat_list[seurat_idx]), "UpperLayer1", "WT<HET<HOM", "DEGs.csv", sep = "-"
    )
  )
)
datatable_download_exp(up)
...
write.csv(
  ...
  file.path(
    ...
    "comb",
    "04-DEGs",
    paste(sub_name, names(seurat_list[seurat_idx]), "UpperLayer1", "HET", "DEGs.csv", sep = "-")
  )
)
datatable_download_exp(up)
...
write.csv(
  ...
  file.path(
    ...
    "04-DEGs",
    paste(
      sub_name, names(seurat_list[seurat_idx]), "UpperLayer1", "HETnoHOM", "DEGs.csv", sep = "-"
    )
  )
)
datatable_download_exp(up)
...
write.csv(
  ...
  file.path(
    ...
    "comb",
    "04-DEGs",
    paste(sub_name, names(seurat_list[seurat_idx]), "UpperLayer1", "HET+HOM", "DEGs.csv", sep = "-")
  )
)
datatable_download_exp(up)
...
write.csv(
  ...
  file.path(
    ...
    "comb",
    "04-DEGs",
    paste(sub_name, names(seurat_list[seurat_idx]), "UpperLayer1", "HOM", "DEGs.csv", sep = "-")
  )
)
datatable_download_exp(up)
...
write.csv(
  ...
  file.path(
    ...
    "comb",
    "04-DEGs",
    paste(sub_name, names(seurat_list[seurat_idx]), "UpperLayer1", "HOM+WT", "DEGs.csv", sep = "-")
  )
)
datatable_download_exp(up)
...
write.csv(
  ...
  file.path(
    ...
    "comb",
    "04-DEGs",
    paste(sub_name, names(seurat_list[seurat_idx]), "UpperLayer1", "WT", "DEGs.csv", sep = "-")
  )
)
datatable_download_exp(up)
...
write.csv(
  ...
  file.path(
    ...
    "comb",
    "04-DEGs",
    paste(sub_name, names(seurat_list[seurat_idx]), "UpperLayer1", "WTnoHOM", "DEGs.csv", sep = "-")
  )
)
datatable_download_exp(up)
...
write.csv(
  ...
  file.path(
    ...
    "comb",
    "04-DEGs",
    paste(sub_name, names(seurat_list[seurat_idx]), "UpperLayer1", "WT+HET", "DEGs.csv", sep = "-")
  )
)
datatable_download_exp(up)

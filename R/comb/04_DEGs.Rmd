...
write.csv(
  ...
  file.path(
    ...
    "comb",
    "04-DEGs",
    paste(sub_name, names(seurat_list[seurat_idx]), "UpperLayer01", "DEGs.csv", sep = "-")
  )
)
datatable_download_exp(results)
```
...
write.csv(
  ...
  file.path(
    ...
    "04-DEGs",
    paste(
      sub_name, names(seurat_list[seurat_idx]), "UpperLayer01", "WT<HET<HOM", "DEGs.csv", sep = "-"
    )
  )
)
datatable_download_exp(up)
...
write.csv(
  ...
  file.path(
    ...
    "comb",
    "04-DEGs",
    paste(sub_name, names(seurat_list[seurat_idx]), "UpperLayer01", "HET", "DEGs.csv", sep = "-")
  )
)
datatable_download_exp(up)
...
write.csv(
  ...
  file.path(
    ...
    "04-DEGs",
    paste(
      sub_name, names(seurat_list[seurat_idx]), "UpperLayer01", "HETnoHOM", "DEGs.csv", sep = "-"
    )
  )
)
datatable_download_exp(up)
...
write.csv(
  ...
  file.path(
    ...
    "comb",
    "04-DEGs",
    paste(sub_name, names(seurat_list[seurat_idx]), "UpperLayer01", "HET+HOM", "DEGs.csv", sep = "-")
  )
)
datatable_download_exp(up)
...
write.csv(
  ...
  file.path(
    ...
    "comb",
    "04-DEGs",
    paste(sub_name, names(seurat_list[seurat_idx]), "UpperLayer01", "HOM", "DEGs.csv", sep = "-")
  )
)
datatable_download_exp(up)
...
write.csv(
  ...
  file.path(
    ...
    "comb",
    "04-DEGs",
    paste(sub_name, names(seurat_list[seurat_idx]), "UpperLayer01", "HOM+WT", "DEGs.csv", sep = "-")
  )
)
datatable_download_exp(up)
...
write.csv(
  ...
  file.path(
    ...
    "comb",
    "04-DEGs",
    paste(sub_name, names(seurat_list[seurat_idx]), "UpperLayer01", "WT", "DEGs.csv", sep = "-")
  )
)
datatable_download_exp(up)
...
write.csv(
  ...
  file.path(
    ...
    "comb",
    "04-DEGs",
    paste(sub_name, names(seurat_list[seurat_idx]), "UpperLayer01", "WTnoHOM", "DEGs.csv", sep = "-")
  )
)
datatable_download_exp(up)
...
write.csv(
  ...
  file.path(
    ...
    "comb",
    "04-DEGs",
    paste(sub_name, names(seurat_list[seurat_idx]), "UpperLayer01", "WT+HET", "DEGs.csv", sep = "-")
  )
)
datatable_download_exp(up)

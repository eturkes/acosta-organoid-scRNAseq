...
**Comparison with `Seurat::FindClusters`: HOM-WT**
...
**Same comparison but using a simple HOM-WT limma model**
...
```{r}
seurat_DEGs <- FindMarkers(sub_seurat, "HOM", "WT", verbose = FALSE)
datatable_download_exp(seurat_DEGs)
VlnPlot(sub_seurat, rownames(seurat_DEGs)[1:12])
